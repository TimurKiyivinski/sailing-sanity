...
module.exports = {
  ...
  /***************************************************************************
   * This is specific to your scanner settings. This application uses SANE.  *
   * `scanList` is the command to get the scanner devices.                   *
   * `scanName` is the command to get the scanner names.                     *
   * `scanSave` is the command to scan an image.                             *
   *                                                                         *
